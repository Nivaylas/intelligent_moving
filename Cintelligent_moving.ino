...
void turn_degree(int deg){
    ...
    switch (deg){
        //right
        case -180:
            Turn(1550, 1550, 97);//逆时针掉头
            //rightDetect();
        break;
        case -135:
            Turn(1550, 1550, 73);//右转135°
            //rightDetect();
        break;
        case -90:
            Turn(1550, 1550, 49);//右转90°
            //rightDetect();
        break;
        case -45: 
            Turn(1550, 1550, 24);//右转45°
            //rightDetect();
        break;
        //left
        case 45:
            Turn(1450, 1450, 24);//左转45°
            //leftDetect();
        break; 
        case 90:
            Turn(1450, 1450, 49);//左转90°//52
            //Turn_ge(1450, 1450, 15, 13);
            //leftDetect();
        break;
        case 135: 
            Turn(1450, 1450, 73);//左转135°
            //leftDetect();
        break;
        case 180:
            Turn(1450, 1450, 97);//逆时针掉头
            //leftDetect();
        break;
    } 
}
...
void QTI(int Reverse = 1){
    ...
    if(Reverse == 1)
        ...
        /*switch(QTIState){//选择qti传感器状态
        case 12:                 
            Turn(1480, 1500);//微小幅向zuo转
            break;
        case 3:
            Turn(1500, 1520);//微小幅向you转
            break;
        default:*/
            Back(1);//后2小步
            //break;
